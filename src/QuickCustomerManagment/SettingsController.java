...
public class SettingsController implements Initializable {
	...
	private void loadSettingsWindowText() {
		...
		this.defaultcurrencySettingsDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowDefaultcurrencyText"));
		this.settingsHeader.setText(AppDataSettings.languageBundle.getString("settingsWindowDefaultcurrencyText"));
		this.yourCompanyDetailsLabel.setText(AppDataSettings.languageBundle.getString("settingsWindowCompanydetailshintText"));
		this.companyDetailsCompanynameDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowCompanynameText"));
		this.companyDetailsCompanystreetDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowCompanystreetText"));
		this.companyDetailsCompanypostcodeDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowPostcodeText"));
		this.companyDetailsCompanycityDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowCityText"));
		this.companyDetailsCompanycountyDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowCountyText"));
		this.companyDetailsCompanycountryDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowCountryText"));
		this.companyDetailsCompanytaxnoDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowTaxnoText"));
		this.companyDetailsCompanyemailDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowEmailText"));
		this.companyDetailsCompanytelephoneDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowPhoneText"));
		this.companyDetailsCompanywebsiteDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowWebsiteText"));
		this.companyDetailsCompanyadditionalinfoDesc.setText(AppDataSettings.languageBundle.getString("settingsWindowAdditionalinfoText"));
